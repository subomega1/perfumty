...
const PerfumeSchema = new mongoose.Schema({
    ...
    intensity: { type: String, enum: ['Eau de Toilette', 'Eau de Parfum', 'Pure Parfum'], required: true },
    bottle_material: { type: String, enum: ['Standard', 'Custom'], required: true },
    premium_ingredients: { type: [String], enum: ['Oud', 'Saffron', 'Tuberose'] },
