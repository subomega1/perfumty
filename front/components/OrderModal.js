...
export default function OrderModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-xl max-w-lg w-full p-8 relative shadow-lg shadow-purple-300 transition-all ease-in-out duration-300">
        <button
          onClick={onClose}
        ...
        <h2 className="text-3xl font-semibold text-center mb-6 text-gray-800 dark:text-white">Complete Your Order</h2>
